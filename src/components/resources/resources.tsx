  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Here are some links of interest, cause out there are websites like
          SpaceSpeak.com that allows people to send a text in audio or a image
          message out into space by radio waves. Once a photon is broadcast into
          space, it persists. It never dies. It never decays.. Radio waves are
          just another form of photon. And once a photon is broadcast into
          space, it persists. It never dies. It never decays. A million years
          from now, maybe the earth is gone, maybe the solar system is gone, but
          your message is still out there, and essentially become archaeological
          photons for some future generation to see what we were about.
          <br></br>
          <br></br>
        </p>
      ...
      <div className={resourcesStyle.links}>
        <ul>
          ...
          <li>
            <span className={resourcesStyle.yellow}>//////</span>
            <a href="https://nssdc.gsfc.nasa.gov/planetary/" target="_blank">
        ...
        <img
          src="/humanity.png"
          alt="Humanity in a nutshell"
          className={resourcesStyle.humanity}
        />
      </div>
    </>
  );
